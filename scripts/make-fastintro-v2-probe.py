"""Create a structurally valid, two-frame intro for repeatable menu probes.

Every content/layer/null declaration remains present.  Each animation track keeps
its first real frame (with a one-frame delay), avoiding the invalid empty-ANM2
experiment while removing the original 4,522-frame per-track timeline.
Production isaac-nosfx.zip is read-only.
"""
...
OUTPUT = ROOT / "web" / "emu" / "isaac-nosfx-fastintro-v2.zip"
TARGETS = {
