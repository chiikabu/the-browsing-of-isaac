...
void imp_steam_api__CSteamAPIContext_GetSteamGenericInterface(CpuState *restrict cpu);
void imp_steam_api__CSteamAPIContext_ConnectToGlobalUser(CpuState *restrict cpu);
